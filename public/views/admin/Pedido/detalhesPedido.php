        ...
        <table id="tabela-itens-pedidos" class="table table-condensed table-striped table-hover">
            <thead>
                ...
                <tr>
                    ...
                    ?>
                    <th class="center-header-table col-xs-3 text-center">#</th>
                    <th class="center-header-table col-xs-6">Produtos</th>
                    <th class="center-header-table col-xs-3 text-center">Qtde</th>
                    <?php
                        endif;
                    ?>
                </tr>
