...
<html lang="pt-br">
    <head>
        ...
        <meta charset="UTF-8" />
        <meta name="keywords" content="distribuidora health, presidente prudente">
        <meta name="description" content="distribuidora health de presidente prudente">
        <meta name="author" content="Lucas S. Rosa (lucas.tarta@hotmail.com)">

        <title><?= $this->dados->title; ?> - Distribuidora Health</title>
